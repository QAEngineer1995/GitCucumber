...
// Bar Chart Example
var ctx = document.getElementById("myBarChartfour");
var myBarChartone = new Chart(ctx, {
  type: 'bar',
   height: 150,
  data: {
...
// Bar Chart Example
var ctx = document.getElementById("myBarChartfive");
var myBarChartone = new Chart(ctx, {
  type: 'bar',
   height: 150,
  data: {
...
// Bar Chart Example
var ctx = document.getElementById("myBarChartsix");
var myBarChartone = new Chart(ctx, {
  type: 'bar',
   height: 150,
  data: {
...
// Bar Chart Example
var ctx = document.getElementById("myBarChartseven");
var myBarChartone = new Chart(ctx, {
  type: 'bar',
   height: 150,
  data: {
