$(document).ready(function () {
    var table = $('#broker-invoice-item-list').DataTable({
        ...
        "initComplete": function (settings, json) {  
            $("#broker-invoice-item-list").wrap("<div style='overflow:auto; width:100%;position:relative;'></div>");            
          },
        'pagingType': 'simple',
        'responsive': true,
        'scrollX': false,
    ...
    $("#broker-invoice-item-list_length").addClass('mt-2').html('<span class="text-gray-500">Total Rows: <b>25</b></span>');


    $('#broker-invoice-item-header-two').removeClass("d-sm-flex").css("display", "none");
    $('#broker-invoice-item-header-two').removeClass("d-sm-flex").hide();
    ...
    $(".cb-element-one, #selectAllInvoiceItem").on('change', function(e) {
        ...
        if ($('.cb-element-one:checked').length > 0) {
            $('#broker-invoice-item-header-one').removeClass("d-sm-flex").css("display", "none");
            $('#broker-invoice-item-header-two').addClass("d-sm-flex").css("display", "block");
        } else {
        $('#broker-invoice-item-header-one').addClass("d-sm-flex").css("display", "block");
            $('#broker-invoice-item-header-two').removeClass("d-sm-flex").css("display", "none");
...
/**********************************************************************************/
$(document).ready(function () {
    var table = $('#broker-payments-list-table').DataTable({
        ...
        "initComplete": function (settings, json) {  
            $("#broker-payments-list-table").wrap("<div style='overflow:auto; width:100%;position:relative;'></div>");            
          },
        'pagingType': 'simple',
        'responsive': true,
        'scrollX': false,
    ...
    $("#broker-payments-list-table_length").addClass('mt-2').html('<span class="text-gray-500">Total Rows: <b>25</b></span>');
