...
! function(s) {
    "use strict";
    s("#sidebarToggleRight, .sidebarToggleTopRight").on("click", function(e) {
        s("body").toggleClass("sidebar-toggled-right"), s(".sidebar-right").toggleClass("toggled-right"), s(".sidebar-right").hasClass("toggled-right") && s(".sidebar-right .collapse-right").collapse("hide")
    }), s(window).resize(function() {
        s(window).width() < 768 && s(".sidebar-right .collapse-right").collapse("hide"), s(window).width() < 480 && !s(".sidebar-right").hasClass("toggled-right") && (s("body").addClass("sidebar-toggled-right"), s(".sidebar-right").addClass("toggled-right"), s(".sidebar-right .collapse-right").collapse("hide"))
    }), s("body.fixed-nav .sidebar-right").on("mousewheel DOMMouseScroll wheel", function(e) {
        if (768 < s(window).width()) {
            var o = e.originalEvent,
                l = o.wheelDelta || -o.detail;
            this.scrollTop += 30 * (l < 0 ? 1 : -1), e.preventDefault()
